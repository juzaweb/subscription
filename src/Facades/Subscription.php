 ...
 * @method static \Juzaweb\Modules\Subscription\Entities\SubscribeResult create($user, string $module, ?\Juzaweb\Modules\Subscription\Models\Plan $plan, \Juzaweb\Modules\Subscription\Models\SubscriptionMethod $method, array $options = [], bool $testMode = false)
